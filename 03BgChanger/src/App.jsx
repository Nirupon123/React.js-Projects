...
function App() {
  ...
  return (
    <>
      ...
      <h1 className="text-center mx-auto py-80 font-bold text-3xl text-white ">Hello Guys here is my first React-Tailwind Project</h1>
      </div>
      <div className="fixed flex  flex-wrap justify-center bottom-12 inset-x-0 px-2">
        <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl">
          ...
          <button onClick={()=>setColor("pink")}className="outline-none px-4 py-1 rounded-full text-red-950 shadow-lg" style={{backgroundColor:"pink"}}>Pookie Color</button>
